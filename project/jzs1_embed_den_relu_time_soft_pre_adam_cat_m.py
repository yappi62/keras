...
model.compile(optimizer='adam', loss='categorical_crossentropy', mask_cost=True) # mean_squared_error, categorical_crossentropy

print('Training ...')
fResult = open('jzs1_embed_den_relu_time_soft_pre_adam_cat_m.txt', 'w')
...
for i in range(0, EPOCHS):
	...
	for j in range(len(aX)/BATCH_SIZE):
		fResult = open('jzs1_embed_den_relu_time_soft_pre_adam_cat_m.txt', 'a+')
...
model.save_weights('jzs1_embed_den_relu_time_soft_pre_adam_cat_m.hdf5', overwrite=True)
