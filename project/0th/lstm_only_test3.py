...
print('Build model ...')
model = Sequential()
model.add(LSTM(vocab_size, EMBED_SIZE))
model.add(RepeatVector(ans_maxlen))
model.add(LSTM(EMBED_SIZE, EMBED_SIZE, return_sequences=True))
model.add(Dense(EMBED_SIZE, vocab_size))
