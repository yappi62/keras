...
print('Training ...')
fResult = open('jzs1_m_den_relu_time_soft_pre_adam_cat_m.txt', 'w')
...
for i in range(0, EPOCHS):
	...
	for j in range(len(X)/BATCH_SIZE):
		fResult = open('jzs1_m_den_relu_time_soft_pre_adam_cat_m.txt', 'a+')
...
model.save_weights('jzs1_m_den_relu_time_soft_pre_adam_cat_m.hdf5', overwrite=True)
