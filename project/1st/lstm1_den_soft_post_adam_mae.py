...
model.compile(optimizer='adam', loss='mean_absolute_error') # mean_squared_error, mean_absolute_error, categorical_crossentropy

print('Training ...')
fResult = open('lstm1_den_soft_post_adam_mae.txt', 'a+')
