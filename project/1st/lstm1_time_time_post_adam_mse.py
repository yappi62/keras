...
model.compile(optimizer='adam', loss='mean_squared_error') # mean_squared_error, mean_absolute_error, categorical_crossentropy

print('Training ...')
fResult = open('lstm1_time_time_post_adam_mse.txt', 'a+')
