...
model.add(LSTM(HIDDEN_SIZE, vocab_size, return_sequences=True))

model.compile(optimizer='adam', loss='categorical_crossentropy') # categorical_crossentropy, mean_squared_error

print('Training ...')
fResult = open('lstm3_post_adam_cat.txt', 'a+')
