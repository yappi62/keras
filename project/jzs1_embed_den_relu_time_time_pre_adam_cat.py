...
print('Training ...')
fResult = open('jzs1_embed_den_relu_time_time_pre_adam_cat.txt', 'w')
...
class LossHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fResult = open('jzs1_embed_den_relu_time_time_pre_adam_cat.txt', 'a+')
...
model.save_weights('jzs1_embed_den_relu_time_time_pre_adam_cat.hdf5', overwrite=True)
