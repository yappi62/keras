...
print('Training ...')
fResult = open('lstm_embed_den_time_time_pre_adam_cat.txt', 'w')
...
class LossHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fResult = open('lstm_embed_den_time_time_pre_adam_cat.txt', 'a+')
...
model.save_weights('lstm_embed_den_time_time_pre_adam_cat.hdf5', overwrite=True)
