...
print('Training ...')
fResult = open('lstm_embed_den_relu_time_soft_post_adam_cat.txt', 'w')
...
fPredict = open('lstm_embed_den_relu_time_soft_post_adam_cat_pred.txt', 'w')
...
class LossHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fPredict = open('lstm_embed_den_relu_time_soft_post_adam_cat_pred.txt', 'a+')
		...
		fResult = open('lstm_embed_den_relu_time_soft_post_adam_cat.txt', 'a+')
...
model.save_weights('lstm_embed_den_relu_time_soft_post_adam_cat.hdf5', overwrite=True)
