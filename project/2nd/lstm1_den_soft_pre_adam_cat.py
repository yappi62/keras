...
print('Training ...')
fResult = open('lstm1_den_soft_pre_adam_cat.txt', 'w')
...
for i in range(0, EPOCHS):
	...
	for j in range(len(X)/BATCH_SIZE):
		fResult = open('lstm1_den_soft_pre_adam_cat.txt', 'a+')
...
model.save_weights('lstm1_den_soft_pre_adam_cat.hdf5', overwrite=True)
