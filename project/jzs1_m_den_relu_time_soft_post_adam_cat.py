...
print('Training ...')
fResult = open('jzs1_m_den_relu_time_soft_post_adam_cat.txt', 'w')
...
fPredict = open('jzs1_m_den_relu_time_soft_post_adam_cat_pred.txt', 'w')
...
class LossHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fPredict = open('jzs1_m_den_relu_time_soft_post_adam_cat_pred.txt', 'a+')
		...
		fResult = open('jzs1_m_den_relu_time_soft_post_adam_cat.txt', 'a+')
...
model.save_weights('jzs1_m_den_relu_time_soft_post_adam_cat.hdf5', overwrite=True)
