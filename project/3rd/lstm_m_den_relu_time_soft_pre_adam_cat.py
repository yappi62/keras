...
model.add(LSTM(vocab_size, HIDDEN_SIZE))
...
print('Training ...')
fResult = open('lstm_m_den_relu_time_soft_pre_adam_cat.txt', 'w')
...
class LossHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fResult = open('lstm_m_den_relu_time_soft_pre_adam_cat.txt', 'a+')
...
model.save_weights('lstm_m_den_relu_time_soft_pre_adam_cat.hdf5', overwrite=True)
