...
fResult = open('jzs1_embed_den_relu_time_soft_den_post_adam_cat_cnn.txt', 'w')
...
fPredict = open('jzs1_embed_den_relu_time_soft_den_post_adam_cat_cnn_pred.txt', 'w')
...
model.save_weights('jzs1_embed_den_relu_time_soft_den_post_adam_cat_cnn.hdf5', overwrite=True)
