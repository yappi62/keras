...
fResult = open('jzs1_embed_time_soft_den_post_adam_cat_cnn.txt', 'w')
...
fPredict = open('jzs1_embed_time_soft_den_post_adam_cat_cnn_pred.txt', 'w')
...
class LossHistory(Callback):
	def on_batch_end(self, batch, logs={}):
		fResult = open('jzs1_embed_time_soft_den_post_adam_cat_cnn.txt', 'a+')
		loss = logs.get('loss')
...
class LossAccHistory(Callback):
	def on_epoch_end(self, epoch, logs={}):
		fPredict = open('jzs1_embed_time_soft_den_post_adam_cat_cnn_pred.txt', 'a+')
...
model.save_weights('jzs1_embed_time_soft_den_post_adam_cat_cnn.hdf5', overwrite=True)
